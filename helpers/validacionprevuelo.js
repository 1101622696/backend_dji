...
const obtenerDatosvalidacionprevuelo = async (nombreHoja, rango = 'A1:Z1000') => {
...
export const getValidacionPrevuelo = () => obtenerDatosvalidacionprevuelo('2.ValidacionPrevuelo');
